...
void draw() {
  ...
  } /*else if (ballXpos < racketOneHitbox[0]-racketOneHitbox[3]) { // commented out for testing
  ...
  if (ballXpos > racketTwoHitbox[0]-ballSize/2 && ballXpos < racketTwoHitbox[0] + racketTwoHitbox[3] && ballYpos >= racketTwoHitbox[1] && ballYpos < (racketTwoHitbox[1]+racketTwoHitbox[2])) {
    ...
    if (racketTwoMoving[0] == 1 && racketTwoMoving[1] == 0) {
      ...
      ballYspeed += 1; 
       ...
       // not moving. Keeping it for possible future use.
    } */   

  } /*else if (ballXpos > racketTwoHitbox[0]+racketTwoHitbox[3]) { // commented out for testing
     // player two loose
